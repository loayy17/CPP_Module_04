...
int main() {
  ...
  *assignEqualCat = *originalCat;
  ...
  for (int i = 0; i < 11; i++)
    std::cout << "Original Cat Idea[" << i
              << "]: " << originalCat->getBrain()->getIdea(i) << std::endl;
  std::cout << "====================================================== "
            << std::endl;
  for (int i = 0; i < 11; i++)
    std::cout << "Copied Cat Idea[" << i
              << "]: " << copyCat->getBrain()->getIdea(i) << std::endl;
  std::cout << "====================================================== "
            << std::endl;
  for (int i = 0; i < 11; i++)
    std::cout << "Assignment Cat IDeas[" << i
              << "]: " << assignEqualCat->getBrain()->getIdea(i) << std::endl;
  std::cout << "====================================================== "
            << std::endl;
